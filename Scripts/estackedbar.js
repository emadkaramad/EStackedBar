        ...
        var EStackedBarCore = (function () {
            function EStackedBarCore(baseElement, options) {
                    ...
                    for (var i = 0; i < _this.dataManager.getTotalColumns(); i++) {
                        ...
                        for (var j = 0; j < column.sections.length; j++) {
                            ...
                            if (section.hasOwnProperty("date_from") && section.hasOwnProperty("date_to"))
                                items = _this.dataManager.getItemsBySectionIdAndDate(section["id"], section["date_from"], section["date_to"]);
                            else
                ...
                this.onDropped = function (event, ui) {
                    ...
                    // Check overflow
                    var isOverflowAllowed = section.hasOwnProperty("overflow") && section["overflow"] == true;
